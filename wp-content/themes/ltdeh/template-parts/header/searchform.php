...
<form role="search" method="get" action="<?= esc_url( home_url( '/' ) ); ?>" class="dx-form dx-form-navbar dx-form-group-inputs">
	<input class="form-control form-control-style-2" value="" id="<?= $unique_id; ?>" name="s" type="search">
