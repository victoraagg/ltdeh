<div class="modal-cookies">
    <div>
        ...
        <div class="body">
            ...
            <small>Si continúa navegando, consideramos que acepta su uso. Puede cambiar la configuración u obtener más información <a href="<?= get_permalink(42); ?>">aquí.</a></small>
        </div>
    </div>
</div>